...
NSString *const FBSessionStateChangedNotification =@"P4T8MYK96M.br.com.terraqueos.apps.ticketcheck.Login:FBSessionStateChangedNotification";
...
-(void)setupRootViews
{
    //http://stackoverflow.com/questions/8257888/how-to-open-a-viewcontroller-before-application-starts-in-ios
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"nosmidia" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"nosmidia.sqlite"];
